      ...
      <div style={{width:'100%'}}>
        ...
        <div className='table-responsive-md'  style={{marginTop:'5.8%'}}>
          <nav className="navbar navbar-light" style={{width:'100%', marginLeft:'0%'}}>
            <h4 className="navbar-brand" style={{fontSize:'24px',color:'#8f8d8d',fontFamily:'Montserrat'}}>All advertisements</h4>
            ...
            <div className='container'>
              ...
              <div className="card-body">
                ...
                <h5 >{dt.title}</h5>
                <p style={{float:'right',marginTop:'-2%'}}>{dt.type}</p>
                </div>
                <h6 className="card-subtitle mb-2 text-muted">{dt.advertisingCompany}</h6>
...
export default connect(mapStateToProps,{getAll:getAllAdverts,getAdvertsType:getAdvertsType,deleteAdvertisement:deleteAdvert})(AllAdvertisements);