      ...
      <div style={{width:'100%'}}>
        ...
        <div className='table-responsive-md'  style={{marginTop:'5.8%'}}>
          <nav className="navbar navbar-light" style={{width:'100%', marginLeft:'0%'}}>
            <h4 style={{color:'#8f8d8d',fontFamily:'Montserrat'}}>All announcements</h4>
          </nav>
            <div className='container'>
...
export default connect(mapStateToProps,{getAll:getAnnouncements,deleteAnnouncement:deleteAnnouncement})(AllAnnouncements);