    ...
    return (
      <div style={{width:'100%'}}>
        ...
        <nav className="navbar navbar-light" style={{width:'100%', marginLeft:'0%'}}>
          <h4 className="navbar-brand" style={{fontSize:'24px',color:'#8f8d8d',fontFamily:'Montserrat'}}>Rica Products</h4>
          <form className="form-inline" onSubmit={this.handleSubmit}>
            <input 
              ...
              type="search"/>
            <button className="btn btn-outline-secondary my-2 my-sm-0 mr-sm-2" type="submit">Search</button>
            <button 
