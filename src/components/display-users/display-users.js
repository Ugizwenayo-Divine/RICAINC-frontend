  ...
  render (){
    ...
    return (
      <div style={{width:'100%'}}>
        ...
        <h4 style={{color:'#8f8d8d',fontFamily:'Montserrat'}}>Rica registered users</h4>
        </nav>
...
export default connect(mapStateToProps,{getAll:getAllUsers,deleteUser:deleteUser})(AllUsers);